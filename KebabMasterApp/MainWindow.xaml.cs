...
namespace KebabMasterApp
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private readonly IDisplayStrategyContext displayStrategyContext;

        public MainWindow(
            IServiceProvider serProv,
            IDisplayStrategyContext strategyContext)
        {
            try
            {
                ...
                displayStrategyContext = strategyContext;

                InitializeComponent();

                var strategy = displayStrategyContext.GetStrategyFromCommandArgs();
